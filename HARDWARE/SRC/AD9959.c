...
#define SDIO2_Pin           GPIO_PIN_6
#define SDIO3_GPIO_Port     GPIOG
...
driverIO GND = {GND_GPIO_Port, GND_Pin};
...
/**
 * @brief Initializes GPIO for the AD9959 module.
 */
void _Init_AD9959_GPIO(void)
{
    ...
    driverIO __GPIOset[14]={SDIO0,SDIO1,SDIO2,SDIO3,PS0,PS1,PS2,PS3,PDC,RST,UPDATE,CS,SCLK,GND};

    for (int i=0; i<14; i+=1) {
        GPIO_InitStruct.Pin=__GPIOset[i].Pin;
        GPIO_InitStruct.Mode=GPIO_MODE_OUTPUT_PP;
        GPIO_InitStruct.Pull=GPIO_PULLDOWN;
        GPIO_InitStruct.Speed=GPIO_SPEED_FREQ_HIGH;
        HAL_GPIO_Init(__GPIOset[i].GPIOx, &GPIO_InitStruct);
    }
